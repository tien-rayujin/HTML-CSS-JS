...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"main3.js":[function(require,module,exports) {
...
function renderTodoList() {
  ...
  state.tasks.forEach(function (task) {
    // create task element
    var item = createTaskEl(task.id, task.name);
...
function handleFormSubmit(e) {
  e.preventDefault();
  var newItem = createTask(state.taskName);
  state.tasks = [].concat(_toConsumableArray(state.tasks), [newItem]);
  state.taskName = "";
  renderInput();
  renderTodoList();
}
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","main3.js"], null)
//# sourceMappingURL=/main3.1797395b.js.map